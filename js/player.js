...
function initPlayer(videoUrl) {
    ...
    art.on('ready', () => {
        ...
        // Add custom AirPlay button
        if (isWebkit) { // Only add if WebKit (Safari) as AirPlay is WebKit-specific
            art.controls.add({
                name: 'airplay-button',
                position: 'right',
                html: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M5 12H3C3 16.9706 7.02944 21 12 21C16.9706 21 21 16.9706 21 12H19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 3V5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M19 12H21C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12H5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>', // AirPlay icon
                tooltip: 'AirPlay',
                click: function() {
                    if (this.airplay) {
                        this.airplay();
                    } else {
                        this.notice.show = 'AirPlay Not Available';
                    }
                }
            });
        }
